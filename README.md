...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/micrometa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15211&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/micrometa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `micrometa` can be installed with:

```
conda install micrometa
```

It is possible to list all of the versions of `micrometa` available on your platform with:
